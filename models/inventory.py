...
class kedai_kopi_inventory_category(models.Model):
    ...
    kedai_kopi_inventory_category_ids  = fields.One2many('kedai.kopi.inventory.item', 'kedai_kopi_inventory_category_id', string="kedai Kopi Inventory Category Ids")
...
class kedai_kopi_inventory_item(models.Model):
    ...
    kedai_kopi_inventory_category_id = fields.Many2one('kedai.kopi.inventory.category',  string="Kedai Kopi Inventory Category Id")
